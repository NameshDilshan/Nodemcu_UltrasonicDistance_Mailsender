...
const char* ssid = "BELL4G-9AC5"; 
const char* password = "F5TBG236E2E";
...
void sendEmail(String stoppedTime){
  ...
  String url = ((String)"http://maker.ifttt.com/trigger/nodemcumailsender/with/key/ecjBZ4QKkisy3yYkUkpGq2yzymKDS25vcsVmmfuCIiv?value1="+stoppedTime);
  Serial.println(url);
...
//    http.begin("https://maker.ifttt.com/trigger/nodemcu_gmail_send/with/key/iwHWHSAXLwrCznidHJnqdyvXt3WsRzVXt1dfwU04TGD");  //Specify request destination
...
//
//  httpsClient.print(String("POST ") + "/trigger/nodemcu_gmail_send/with/key/iwHWHSAXLwrCznidHJnqdyvXt3WsRzVXt1dfwU04TGD" + " HTTP/1.1\r\n" +
...
//
//  client.println("dGhlbWFpbHNlcnZlcm5vZGVtY3Vwcm9qZWN0QGdtYWlsLmNvbQ=="); 
//  if (!emailResp())
//  return 0;
//
//  Serial.println(F("Sending Password"));
//
//  client.println("YW13dmFhdXB4c2ZubnN1aQ==");
//  if (!emailResp())
//  return 0;
//
//  Serial.println(F("Sending From"));
//
//  client.println(F("MAIL From: themailservernodemcuproject@gmail.com"));
//  if (!emailResp())
//  return 0;
//
//  Serial.println(F("Sending To"));
//  client.println(F("RCPT To: nameshdilshan@gmail.com"));
//  if (!emailResp())
//  return 0;
//
...
//
//  client.println(F("To: nameshdilshan@gmail.com"));
//
//  client.println(F("From: themailservernodemcuproject@gmail.com"));
